...
router.post('/add/', 
	[
		...
		body('nom_fournisseurs').optional({nullable: true, checkFalsy: true}),
		body('gaz').optional({nullable: true, checkFalsy: true}),
		body('electrcite').optional({nullable: true, checkFalsy: true}),
		body('verte').optional({nullable: true, checkFalsy: true}),
		body('disponible').optional({nullable: true, checkFalsy: true}),
	], validateFormData
